...
from flask_cors import CORS  #Helps the frontend (HTML or JS) talk to the backend without security errors.
import joblib
...
def predict():
    try:
        ...
        # Extract values(if string convert to float)
        ...
        features = [[nitrogen, phosphorus, potassium, temperature, humidity, ph_value]]# 2d array
